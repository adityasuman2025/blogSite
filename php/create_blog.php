<?php
	...
	if(isset($_POST["blog_title"]) && isset($_POST["blog_keywords"]) && isset($_POST["blog_text"]) && isset($_POST["img_address"]) && isset($_POST["user_id"]) && isset($_POST["username"]))
	{
		...
		$query2 = "INSERT INTO `blogs` (`blog_title`, `blog_keywords`, `blog_text`, `img_address`, `added_by`, `added_by_name`) VALUES ('$blog_title', '$blog_keywords', '$blog_text', '$img_address', '$user_id', '$username')";	
