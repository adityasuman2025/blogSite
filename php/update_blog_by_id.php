<?php
	...
	if(isset($_POST["post_id"]) && isset($_POST["blog_title"]) && isset($_POST["blog_text"]) && isset($_POST["img_address"]) && isset($_POST["user_id"]) && isset($_POST["username"]))
	{
		...
		$query2 = "UPDATE `blogs`SET blog_title = '$blog_title', blog_text = '$blog_text', img_address = '$img_address' WHERE blog_id = $post_id";	
